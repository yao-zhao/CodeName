...
public class GUI implements ActionListener{
	...
	public static final int SETUPVIEW = 0;
	public static final int PLAYVIEW = 1;
	...
	public void setFrame () {
		...
		JMenuItem fontup = new JMenuItem("increase font");
		fontup.setActionCommand("increase font");
		fontup.addActionListener(this);
		menu.add(fontup);

		JMenuItem fontdown = new JMenuItem("decrease font");
		fontdown.setActionCommand("decrease font");
	...
	public void runPlayView () {
		this.currentView = GUI.PLAYVIEW;
		// set base frame
		setFrame();
		// add switch button
		if (isMaster) {
		...
		JButton skipbutton = new JButton("Give Up");
		skipbutton.setActionCommand("give up");
		skipbutton.addActionListener(this);
		skippanel.add(skipbutton,BorderLayout.CENTER);
		c.weightx = .5;
		c.weighty = 1;
		c.gridx = 1;
		c.gridy = 2;
		contentPanelLayout.setConstraints(skippanel, c);
		contentPanel.add(skippanel);
	...
	public void increaseFont () {
		this.font = new Font("Serif",font.getStyle(), font.getSize()+10);
		//	frame.repaint();
		refresh();
	}
	...
	public void runSetupView() {
		this.currentView = GUI.SETUPVIEW;
